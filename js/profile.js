...
// ================================================================ */
// ГЛАВНАЯ ФУНКЦИЯ — ВСЕ КНОПКИ ТУТ
// ================================================================ */
...
function showProfileActions(uid) {
    ...
    // ================================================================ */
    // СВОЙ ПРОФИЛЬ — КНОПКА ⋮ В ПРАВОМ ВЕРХНЕМ УГЛУ
    // ================================================================ */
    if (uid === USER_UID) {
        // НАХОДИМ .profile-header
        ...
        // ДОБАВЛЯЕМ ЗАКРЫТИЕ МЕНЮ ПРИ КЛИКЕ ВНЕ
